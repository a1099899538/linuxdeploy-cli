...
do_install()
{
    ...
    debian:*|ubuntu:*|kali:*)
        packages="desktop-base dbus-x11 x11-xserver-utils xfonts-base xfonts-utils xfonts-75dpi xfonts-100dpi xfce4 xfce4-terminal tango-icon-theme hicolor-icon-theme pm-utils"
